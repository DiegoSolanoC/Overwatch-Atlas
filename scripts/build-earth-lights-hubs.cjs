/**
 * Builds data/earth-lights-hubs.json — same hub rules as src/features/world/utils/EarthLightsData.js (transport + events).
...
/** Keep in sync with src/features/world/utils/EarthLightsData.js — isExcludedEarthLightHub */
