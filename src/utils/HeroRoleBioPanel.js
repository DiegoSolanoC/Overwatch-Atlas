/**
 * Heroes archive: **Role** + **Subrole** in the static bio edit strip (#eventSlideHeroLocationsEdit).
 */
...
/**
 * Repopulate subrole `<select>` from the current Role value.
...
/** @deprecated Use syncHeroBioRolePanelsVisibility */
export function syncHeroRoleBioPanelVisibility(archiveSource, heroRoleForPopulate) {
    syncHeroBioRolePanelsVisibility(archiveSource, heroRoleForPopulate, '');
}
