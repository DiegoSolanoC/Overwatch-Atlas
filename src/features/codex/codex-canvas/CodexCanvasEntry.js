...
if (typeof window !== 'undefined') {
    window.CodexCanvasService = {
        ...
        getCodexLinkFiltersEnabled: () => window.CodexLinkFiltersToggle?.isEnabled?.() ?? false,
        setCodexLinkFiltersEnabled: (v) => window.CodexLinkFiltersToggle?.setEnabled?.(v),
        toggleCodexLinkFilters: () => window.CodexLinkFiltersToggle?.toggle?.(),
