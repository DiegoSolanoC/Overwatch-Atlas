...
class FilterService {
    constructor(stateManager = null, imageService = null, globeController = null, soundManager = null) {
        ...
        this.buttonCache = { heroes: null, factions: null, npcs: null, countries: null, music: null };
    ...
    isStandaloneMode() {
        return typeof window !== 'undefined' && window.standaloneActiveFilters instanceof Set;
    }
    ...
    async createFilterButtons(items, type, folder) {
        ...
        if (groupFactionsByArchiveType) await ensureArchiveLayoutSnapshotsForFilter('factions');
        if (groupHeroesByArchiveRole) await ensureArchiveLayoutSnapshotsForFilter('heroes');
    ...
    openPanel() {
        ...
        const eventSlide = document.getElementById('eventSlide');
        if (eventSlide?.classList.contains('open')) eventSlide.classList.remove('open');
        ...
        const t = this.currentFilterType;
        this.createFilterButtons(tabItems[t] || this.npcs, t, tabFolder[t] || tabFolder.npcs);
        ...
        this._onAtlasBioArchivesRefreshedForFilters = (ev) => {
            ...
            const repaintCurrentFilterTab = () => {
                ...
                const items = {
                    ...
                    npcs: this.npcs, countries: this.countries
                };
