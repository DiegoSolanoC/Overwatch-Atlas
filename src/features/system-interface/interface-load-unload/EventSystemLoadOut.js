...
import { lookAndAddElement } from "../../universal-features/atlas-shared-ui/dom/lookAndAddElement.js";
import { createEventPagination } from "../interface-bottom-dock/EventPaginationDom.js";
import { createFiltersPanel } from "../interface-filter-menu/filtersPanelMarkup.js";
import { createHeaderHubButton } from "../../universal-features/atlas-header/HeaderHubButton.js";
import { EventMarkerManager } from "../interface-globe-markers/EventMarkerManager.js";
import {
  teardownMenuHelpersEventSystemLayout,
  sweepEventSystemDockOrphans,
  ensureDockGlobeRailCenterRestored,
} from "../interface-bottom-dock/dockChromeLifecycle.js";
import { installEventSlidePlainPasteGuard } from "../interface-info-display/installEventSlidePlainPasteGuard.js";
import {
  ...
  try {
    ...
    if (!window.eventManager) {
      const { initializeEventManager } =
        await import("../interface-left-panel/event-system/boot/bootEventManager.js");
    ...
    if (!window.flashButton) {
      await import("../interface-shared/dialogs/flashButton.js");
    }
