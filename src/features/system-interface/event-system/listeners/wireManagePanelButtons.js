 ...
 */
export function wireManagePanelButtons(listenerService, { panel, toggleBtn, closeBtn }) {
    ...
    if (toggleBtn && panel) {
        ...
        newToggleBtn.addEventListener('click', (e) => {
            ...
            // Mutual exclusion with the music panel.
            ...
            // Mutual exclusion with the filters panel.
            ...
            if (isNowOpen) {
                try { window.SummaryInfoBadge?.hide(); } catch (_) {}
