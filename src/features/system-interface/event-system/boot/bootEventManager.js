...
async function _loadEventManagerScript() {
  return new Promise((resolve, reject) => {
    ...
    script.type = "module";
    script.src =
      "src/features/system-interface/coordinator/EventManager.js?" + Date.now();
...
async function createEventManagerInstance() {
  ...
  await ensureGlobalServiceScript(
    "EventDataService",
    "src/features/system-interface/event-system/data/EventDataService.js",
  );
  await ensureGlobalServiceScript(
    "EventInitService",
    "src/features/system-interface/event-system/boot/runEventManagerInit.js",
  );
