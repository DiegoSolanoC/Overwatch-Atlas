/**
 * LocationTypeFields - Handles location type switching and field visibility
 * Manages location type buttons, hidden input, and coordinate field visibility
 */

class LocationTypeFields {
    constructor() {
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = LocationTypeFields;
}

if (typeof window !== 'undefined') {
    window.LocationTypeFields = LocationTypeFields;
}
