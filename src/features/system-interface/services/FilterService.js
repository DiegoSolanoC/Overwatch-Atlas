...
class FilterService {
        ...
        this.imageService = imageService || new (window.FilterImageService || class {
            ...
            buildImagePath(item, type, folder) {
                if (type === 'factions') {
                    ...
                    return `src/assets/images/Music/${encodeURIComponent(iconName)}.png`;
                } else {
            ...
            if (!this._onAtlasBioArchivesRefreshedForFilters) {
                this._onAtlasBioArchivesRefreshedForFilters = (ev) => {
                    ...
                    const repaintCurrentFilterTab = () => {
                        ...
                        if (type === 'heroes') {
                            this.createFilterButtons(this.heroes, 'heroes', 'src/assets/images/Filters/Heroes');
                        } else if (type === 'factions') {
                            this.createFilterButtons(this.factions, 'factions', 'src/assets/images/Filters/Factions');
                        } else if (type === 'npcs') {
                            this.createFilterButtons(this.npcs, 'npcs', 'src/assets/images/Filters/NPCs');
                        } else if (type === 'countries') {
                            this.createFilterButtons(this.countries, 'countries', 'src/assets/images/Filters/Flags');
                        }
            ...
            try {
                ...
                try {
                    const modUrl = new URL(
                        'src/features/system-interface/services/helpers/FilterArchiveOrderHelpers.js',
                        document.baseURI
                    ).href;
                ...
                if (this.factions.length > 0) {
                    setTimeout(() => this.preloadImages(this.factions, 'factions', 'src/assets/images/Filters/Factions'), 500);
                }
                if (this.npcs.length > 0) {
                    setTimeout(() => this.preloadImages(this.npcs, 'npcs', 'src/assets/images/Filters/NPCs'), 650);
                }
            } catch (error) {
    ...
    invalidateBioArchiveFilterLayouts() {
        ...
        if (t === 'factions') {
            void this.createFilterButtons(this.factions, 'factions', 'src/assets/images/Filters/Factions');
        } else if (t === 'heroes') {
            void this.createFilterButtons(this.heroes, 'heroes', 'src/assets/images/Filters/Heroes');
        } else {
            return;
        }
        if (typeof this._applyCurrentCategorySearch === 'function') {
            ...
            helper(
                ...
                async (panel, button, stateManager, getSceneModel, currentType, heroes, factions, npcs, countries, createFilterButtons) => {
                    ...
                    if (currentType === 'heroes') {
                        await createFilterButtons(heroes, 'heroes', 'src/assets/images/Filters/Heroes');
                    } else if (currentType === 'factions') {
                        await createFilterButtons(factions, 'factions', 'src/assets/images/Filters/Factions');
                    } else if (currentType === 'countries') {
                        await createFilterButtons(countries || [], 'countries', 'src/assets/images/Filters/Flags');
                    } else {
                        await createFilterButtons(npcs, 'npcs', 'src/assets/images/Filters/NPCs');
                    }
                    this.updateButtonStates();
