...
import { getEventThumbNumberButtonsHtml } from '../../features/system-interface/managers/helpers/PaginationThumbMarkup.js';
import {
    applyPaginationDockViewportMode,
    initPaginationDockCollapse,
} from '../../features/system-interface/utils/PaginationDockCollapse.js';
...
export function createEventPagination(statusService) {
    ...
    const setupPaginationPlacement = () => {
        ...
        /* Top edge y=3 matches TRAPEZOID_BORDER_SVG flat segment (2,3–98,3); y=0 left fill peeking above the white stroke. */
