...
import { STRIP_CATEGORIES } from '../archive-category-shared/ArchiveCategoryTypes.js';
...
function createCategoryToolbar(callbacks) {
    ...
    toolbar.setAttribute('aria-label', 'Data Workshop categories');
...
function createBackButton(callbacks) {
    ...
    backBtn.setAttribute('title', 'Back to Data Workshop categories');
    backBtn.innerHTML = `
