...
const NPC_ARCHIVE_CATEGORY_ALIASES = Object.freeze({
    ...
    overwatch: 'Overwatch',
    talon: 'Talon',
    'null sector': 'Null Sector',
    'historical figure': 'Influential Figures',
    'historical figures': 'Influential Figures',
    'influential figure': 'Influential Figures',
...
export const NPC_ARCHIVE_CATEGORY_BY_NAME = Object.freeze({
    ...
    Adeyemi: 'Talon',
    Lanet: 'Null Sector',
    Nameless: 'Null Sector',
    Zera: 'Null Sector',
    Aurora: 'Influential Figures',
    Anubis: 'Influential Figures',
    Mondatta: 'Influential Figures',
    Alisa: 'Influential Figures',
    Katya: 'Influential Figures',
    Bhatt: 'Influential Figures',
    Naughton: 'Influential Figures',
    Portero: 'Influential Figures',
    Osai: 'Influential Figures',
    Balderich: 'Influential Figures',
    Palak: 'Influential Figures',
    Ingrid: 'Civilians',
    Emily: 'Civilians',
    Vincent: 'Civilians',
    Iggy: 'Civilians',
