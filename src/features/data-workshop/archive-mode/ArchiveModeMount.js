 ...
 * @param {(restoreMenu?: boolean) => void | Promise<void>} [options.onCancel]
 */
export async function openDataArchiveAtSource(archiveSource = 'heroes', options = {}) {
 ...
 */
export async function unmountDataArchiveMode({ restoreMenu = true } = {}) {
    detachStoryArchiveHubDismissChrome();
