...
import { normalizeSavedPalette, applyPaletteBodyClasses, updateHeaderWebsiteLogo } from './PaletteConstants.js';
import {
...
export function setupPaletteToggle() {
    ...
    window.updatePaletteMenuActiveState = (palette) => updatePaletteMenuActiveState(palette);
