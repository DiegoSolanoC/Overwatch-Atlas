...
export function initHeroBiographyLookRangesEditor(rangesRowEl) {
    ...
    editorEnabled = true;
    rangesRowEl.classList.add('hero-biography-mode__ranges-row--active');

    rangeBlockEl = document.createElement('div');
    rangeBlockEl.className = 'hero-biography-mode__look-event-range';
    rangeBlockEl.hidden = true;

    startInput = document.createElement('input');
    startInput.type = 'text';
    startInput.className = 'hero-biography-mode__look-event-range-input';
    ...
    sep.className = 'hero-biography-mode__look-event-range-sep';
    sep.textContent = '—';
    sep.setAttribute('aria-hidden', 'true');

    endInput = document.createElement('input');
    endInput.type = 'text';
    endInput.className = 'hero-biography-mode__look-event-range-input';
    ...
    confirmBtn.className = 'hero-biography-mode__look-event-range-confirm';
    confirmBtn.textContent = 'Confirm';
    confirmBtn.title = 'Save auto-look range for the selected look';
    confirmBtn.disabled = true;

    statusEl = document.createElement('p');
    statusEl.className = 'hero-biography-mode__look-event-range-status';

    const startWrap = document.createElement('div');
    startWrap.className = 'hero-biography-mode__look-event-range-input-wrap';
    startWrap.appendChild(startInput);

    const endWrap = document.createElement('div');
    endWrap.className = 'hero-biography-mode__look-event-range-input-wrap';
    endWrap.appendChild(endInput);

    const fieldsRow = document.createElement('div');
    fieldsRow.className = 'hero-biography-mode__look-event-range-fields';
...
export function destroyHeroBiographyLookRangesEditor() {
    rangeBlockEl?.parentElement?.classList.remove('hero-biography-mode__ranges-row--active');
    rangeBlockEl?.remove();
    editorEnabled = false;
    rangeBlockEl = null;
    startInput = null;
