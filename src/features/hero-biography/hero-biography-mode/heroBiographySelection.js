...
export function initHeroBiographySelection(hostEl, mainEl) {
    ...
    portraitEl.className = 'hero-biography-mode__portrait';
    portraitEl.setAttribute('aria-hidden', 'true');

    portraitImg = document.createElement('img');
    portraitImg.className = 'hero-biography-mode__portrait-img';
    portraitImg.decoding = 'async';

    const empty = document.createElement('p');
    empty.className = 'hero-biography-mode__portrait-empty';
    ...
    controlsRowEl.className = 'hero-biography-mode__controls-row';

    const lookField = document.createElement('div');
    lookField.className = 'hero-biography-mode__look-field';

    const lookLabel = document.createElement('label');
    lookLabel.className = 'hero-biography-mode__look-select-label';
    ...
    if (isHeroBiographyLocalDev()) {
        ...
        rangesRowEl.className = 'hero-biography-mode__ranges-row';
