...
import { getOrCreateElement, createEventPagination, createFiltersPanel } from '../universal-features/helpers/ComponentDOMHelpers.js';
import { createGlobeControlButton } from '../universal-features/helpers/ComponentLoadHelpers.js';
import { shouldEventBeLocked } from '../system-interface/managers/helpers/MarkerCreationHelpers.js';
 ...
 * @param {Function} setupGlobeHandler - Handler for Interactive Worldview (timeline) button
...
export function createMenuButtons(setupGlobeHandler, setupGlossaryHandler = null, setupBiographyHandler = null) {
    ...
    // Interactive timeline — click opens globe vs map chooser, then loads
        ...
        if (!isLoaded) {
            ...
            try {
                ...
                if (!window.eventManager) {
                    const { initializeEventManager } = await import('../universal-features/helpers/EventManagerHelpers.js');
