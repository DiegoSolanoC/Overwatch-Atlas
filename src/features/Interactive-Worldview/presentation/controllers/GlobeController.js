 ...
 */
import { DataModel } from '../../domain/models/DataModel.js';
import { TransportModel } from '../../domain/models/TransportModel.js';
import { SceneModel } from '../../domain/models/SceneModel.js';
...
import { maybeInstallDevSunYawControl } from '../../debug/DevSunYawControl.js';
import { Map2DLiteLayer } from '../map/Map2DLiteLayer.js';
    ...
    setMapViewEnabled(enabled) {
        ...
        if (!isEnabled) {
            requestAnimationFrame(() => {
                ...
                import('../../debug/DevSunYawControl.js').then(module => {
