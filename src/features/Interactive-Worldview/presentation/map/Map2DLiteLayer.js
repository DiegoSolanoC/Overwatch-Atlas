...
/**
 * @param {import('../../domain/models/DataModel.js').DataModel} dataModel
 ...
 * @param {import('../../domain/models/SceneModel.js').SceneModel} sceneModel
 */
...
export class Map2DLiteLayer {
    /**
     * @param {{ container: HTMLElement, sceneModel: import('../../domain/models/SceneModel.js').SceneModel, dataModel: import('../../domain/models/DataModel.js').DataModel }} opts
     */
