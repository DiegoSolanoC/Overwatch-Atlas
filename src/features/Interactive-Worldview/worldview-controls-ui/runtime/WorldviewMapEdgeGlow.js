 ...
 *
 * Loaded via <script> tag; attaches to window.WorldviewMapEdgeGlow.
 */
class WorldviewMapEdgeGlow {
    static _instance = null;

    static getInstance() {
        if (!WorldviewMapEdgeGlow._instance) {
            WorldviewMapEdgeGlow._instance = new WorldviewMapEdgeGlow();
        }
        return WorldviewMapEdgeGlow._instance;
    }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = WorldviewMapEdgeGlow;
}
if (typeof window !== 'undefined') {
    window.WorldviewMapEdgeGlow = WorldviewMapEdgeGlow;
}
