 ...
 */
import { DataModel } from '../../worldview-domain-state/models/DataModel.js';
import { TransportModel } from '../../worldview-domain-state/models/TransportModel.js';
import { SceneModel } from '../../worldview-domain-state/models/SceneModel.js';
import { GlobeView } from '../../worldview-globe-3d/views/GlobeView.js';
import { TransportView } from '../../worldview-globe-3d/views/TransportView.js';
import { UIView } from '../../worldview-globe-3d/views/UIView.js';
...
} from '../../worldview-shared-assets/debug/DevSunYawControl.js';
import { Map2DLiteLayer } from '../../worldview-map-2d/Map2DLiteLayer.js';
export class GlobeController {
    ...
    _ensureGlobeWorldBuilt(container) {
        ...
        // Story timeline markers are not created here — they are owned by EventMarkerManager
        // (window.globeEventMarkerManager) when the Event System is active. See docs/TIMELINE_WORLDVIEW_CONTRACT.md
        ...
        // Initial fill of dataModel.events from EventManager is not done in this init path;
        // use TimelineMarkerSync / GlobeSyncService / syncEventsWithGlobeCore after events load.
