...
import { getMoonTexturePath, getMarsTexturePath, getOrbitTexturePath } from '../worldview-globe-3d/views/helpers/GlobePlaneHelpers.js';
...
/**
 * @param {import('../../worldview-domain-state/models/DataModel.js').DataModel} dataModel
 ...
 * @param {import('../../worldview-domain-state/models/SceneModel.js').SceneModel} sceneModel
 */
...
export class Map2DLiteLayer {
    /**
     * @param {{ container: HTMLElement, sceneModel: import('../../worldview-domain-state/models/SceneModel.js').SceneModel, dataModel: import('../../worldview-domain-state/models/DataModel.js').DataModel }} opts
     */
