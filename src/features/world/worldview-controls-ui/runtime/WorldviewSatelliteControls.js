/**
 * WorldviewSatelliteControls - Handles satellite creation, updates, and initialization
 */
class WorldviewSatelliteControls {
    ...
    createSatellite(config) {
        ...
        if (type === 'ISS') {
            ...
            if (satelliteModelCache && gltfLoader) {
                ...
                gltfLoader.load('src/assets/models/Satellite.glb', (gltf) => {
                    const model = gltf.scene;
                    const cached = model.clone();
...
if (typeof window !== 'undefined') {
    window.WorldviewSatelliteControls = WorldviewSatelliteControls;
}
