/**
 * WorldviewTouchInteraction - Handles touch event interactions
 */

class WorldviewTouchInteraction {
    ...
    onTouchStart(event) {
        ...
        if (event.touches.length === 1) {
            ...
            // Match mouse path: empty-globe click closes panels only when pointer did not move (see WorldviewMarkerInteraction)
    ...
    onTouchMove(event) {
        ...
        if (event.touches.length === 2) {
            ...
            // Clamp zoom similar to WorldviewCameraControl
        ...
        if (event.touches.length === 1) {
            ...
            if (isMapView) {
                ...
                if (camera && renderer && earthMapPlane) {
                    ...
                    if (window.WorldviewMapEdgeGlow) {
                        const container = document.getElementById('globe-container');
                        const svc = window.WorldviewMapEdgeGlow.getInstance();
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = WorldviewTouchInteraction;
}

// Make globally accessible
if (typeof window !== 'undefined') {
    window.WorldviewTouchInteraction = WorldviewTouchInteraction;
}
