/**
 * WorldviewCameraAnimation - Handles camera animations and zoom operations
 */
class WorldviewCameraAnimation {
...
if (typeof window !== 'undefined') {
    window.WorldviewCameraAnimation = WorldviewCameraAnimation;
}
