/**
 * WorldviewTransportToggles - Handles toggle button setup (auto-rotate, hyperloop)
 */
class WorldviewTransportToggles {
...
if (typeof window !== 'undefined') {
    window.WorldviewTransportToggles = WorldviewTransportToggles;
}
