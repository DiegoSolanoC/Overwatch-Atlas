/**
 * WorldviewAutoRotateController - Handles auto-rotation and event recentering
 * Extracted from WorldviewGlobeController to follow Single Responsibility Principle
 */

export class WorldviewAutoRotateController {
