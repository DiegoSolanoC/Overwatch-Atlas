/**
 * WorldviewCameraViews - Manages camera animations, zoom, and label positioning
 */

export class WorldviewCameraViews {
    constructor(sceneModel, uiView) {
        this.sceneModel = sceneModel;
        this.uiView = uiView; // Reference to WorldviewHudView for accessing originalCameraPosition and originalGlobeRotation
