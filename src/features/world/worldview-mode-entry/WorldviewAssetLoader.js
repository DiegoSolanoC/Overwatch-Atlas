 ...
 * `createLoadProgressTracker` from `universal-features/atlas-mode-runtime/loadProgressTracker.js`
 ...
 *
 * Lives in `world/worldview-mode-entry/` next to
...
import {
    ...
    hideLoadingOverlay,
    setRunOperation
} from '../../universal-features/atlas-mode-runtime/loadingOverlayState.js';
import { updateStatus } from '../../universal-features/atlas-mode-runtime/statusFeed.js';
import { createLoadProgressTracker } from '../../universal-features/atlas-mode-runtime/loadProgressTracker.js';
import { broadcastModeChange } from '../../universal-features/atlas-mode-runtime/mode-lifecycle/broadcastModeChange.js';
import {
    teardownGlobeMapChooserHub,
    syncGlobeMapLaunchLabels
} from './entry/WorldviewMapLaunchChoice.js';
...
async function runEventMarkersStage(progress) {
    ...
    await progress.runStage(
        'eventMarkers',
        async () => {
            const { EventMarkerManager } = await import('../../system-interface/interface-globe-markers/EventMarkerManager.js');
